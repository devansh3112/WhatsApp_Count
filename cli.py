...
def parse_args():
    ...
    # Basic analyzer
    basic_parser = subparsers.add_parser("basic", help="Run basic message count analysis")
    basic_parser.add_argument("--file", "-f", help="Path to WhatsApp chat export file")
    basic_parser.add_argument("--plot", "-p", action="store_true", help="Generate visualization")
    
    # Deep analyzer
    deep_parser = subparsers.add_parser("deep", help="Run comprehensive analysis with visualizations")
    deep_parser.add_argument("--file", "-f", help="Path to WhatsApp chat export file")
    deep_parser.add_argument("--output", "-o", default="output", help="Output directory for visualizations")
    deep_parser.add_argument("--format", choices=["png", "pdf", "svg"], default="png", 
                           help="Image format for visualizations")
    deep_parser.add_argument("--no-plots", action="store_true", help="Skip generating plots")
    
    # List sample chats
    subparsers.add_parser("list-samples", help="List available sample chat files")
